...
function rate = SRCe( trnX ,trnY ,tstX , tstY )
...
Coeff_Test = zeros(ntrn+dim,ntst) ;
...
% 基于类内残差最小的决策规则（SRC使用）
rate = Decision_Residual( A ,trnY ,tstX , tstY , Coeff_Test ) 

% 基于类内系数和最大的决策规则
rate2 = Decision_Coeff( A ,trnY ,tstX , tstY , Coeff_Test ) 
